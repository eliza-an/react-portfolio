  ...
  return (
    <div>
      ...
      <div className='firstCard'>
       ...
       <div className="imageDiv"> <img alt='computer'  className="computer1" src="/img/computer.jpg"></img></div>
      ...
      <div className='firstCard'>
       ...
       <div className="imageDiv"> <img alt='computer' className="computer1" src="/img/computer2.jpg"></img></div>
      ...
      <div className='firstCard'>
       ...
       <div className="imageDiv"> <img alt='computer' className="computer1" src="/img/computer3.jpg"></img></div>
      ...
      <div className='firstCard'>
       ...
       <div className="imageDiv"> <img alt='computer' className="computer1" src="/img/computer4.jpg"></img></div>
      ...
      <div className='firstCard'>
       ...
       <div className="imageDiv"> <img alt='computer' className="computer1" src="/img/computer5.jpg"></img></div>
      ...
      <div className='firstCard'>
       ...
       <div className="imageDiv"> <img alt='computer' className="computer1" src="/img/computer6.jpg"></img></div>
